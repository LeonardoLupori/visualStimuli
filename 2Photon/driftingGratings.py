...
tempFreqs = [1,3]           # (list) Temporal Freqs that will be used for gratings
...
stimuli = list(itertools.product(spFreqs,tempFreqs,oris))
...
while keepGoing:
    ...
    temporalFreq = thisStimulus[1]
    grating.ori = thisStimulus[2]
